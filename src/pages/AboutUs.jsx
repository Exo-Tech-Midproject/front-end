	...
	return (
		...
		<Stack direction="column" height="100%">
			...
			<Box sx={{
				...
				<Container>
					<Stack py={5} alignItems="center" justifyContent="center" alignContent="center" sx={{ height: "100%", width: "100%" }}>
						<Title
							variant={{ xs: "h3", sm: "h2", md: "h1" }}
							sx={{ letterSpacing: "0.02em", my: 3, color: "white", }}
						>
							About Exo-tech Team
						</Title>
						<Typography
							variant="body2"
							sx={{ letterSpacing: "0.02em", mb: 3, color: "white", fontSize: "20px" }}
						>
			...
			<Box sx={{ bgcolor: "white", width: "100%", height: "100%", py: 10 }}>
				<Container>
					<Grid container spacing={5} sx={{
						...
						{ITEMS.map((item) => (
							<Grid item xs={6} md={5} key={item.title}>
								<TeamCard {...item} />
							</Grid>
						))}
					</Grid>
