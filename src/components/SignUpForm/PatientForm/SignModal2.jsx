...
export default function SignModal2({ showModal, setShowModal, handleCloseModal, doneMsg }) {
            ...
            >
                <Box sx={{ ...style, borderRadius: '4px' }} >
                    ...
                    <Box display='flex' justifyContent='end' gap={0.5}>
                        {doneMsg.type === 'success' && <Button variant='contained' color='medical' onClick={handleToLogin}>Go to login</Button>}
                        <Button variant='contained' color='warning' onClick={() => setShowModal(false)}>Close</Button>
                    </Box>
                </Box>
