...
export default function DeletePrescriptionModal({ showModal, handleCloseDeleteModal, handleDeleteCard, prescId }) {
    return (
        <div>
                ...
                <Box sx={{ ...style, borderRadius: '4px' }} >
                    <Box display='flex' flexDirection='column' gap={4} mb={2}>
                        ...
                        <Alert severity="error">
                            ...
                            If you proceed this prescription will be deleted  <strong>permanantly!</strong>
                        </Alert>
                    </Box>
                    <Box display='flex' justifyContent='end' gap={0.5}>
                        <Button variant='contained' color='warning' onClick={() => handleDeleteCard(prescId)}>Proceed</Button>
