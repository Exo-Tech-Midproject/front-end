        ...
        <motion.figure
            ...
            <figcaption>
                ...
                <Box display='flex' justifyContent='flex-end'>
                    <Button component={Link} to={`/prescriptions/${userInfo.username}`} variant='text' color={'snowWhite'}>Prescriptions</Button>
                    <Button component={Link} to={`/vitals/${userInfo.username}`} variant='text' color={'snowWhite'} >Vitals</Button>
                </Box>
