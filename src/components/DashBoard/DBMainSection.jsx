        ...
        <>
            <Main open={open}   >
                <Routes>
                    ...
                    <Route path='/doctor-control/vitals/:patientUN' element={<React.Suspense fallback={<Loading />}><Vitals /></React.Suspense>} />
                    <Route path='/doctor-control/prescription/:patientUN' element={<React.Suspense fallback={<Loading />}><Prescriptions /></React.Suspense>} />
